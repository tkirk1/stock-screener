import type { StocksQuery } from "@stocks/types";

export const tradingViewScanRequest = {
  columns: [
    "ticker-view", "close", "type", "typespecs", "pricescale", "minmov", "fractional", "minmove2", "currency", "change",
    "Perf.W", "Perf.1M", "Perf.3M", "Perf.6M", "Perf.YTD", "Perf.Y", "Perf.5Y", "Perf.10Y", "Perf.All",
    "Volatility.W", "Volatility.M",
  ],
  filter: [
    { left: "exchange", operation: "in_range", right: ["ASX", "HKEX", "LSE", "NASDAQ", "NYSE", "AMEX", "TSX", "EURONEXT"] },
  ...
  markets: [
    "america", "australia", "canada", "france", "germany", "hongkong", "ireland", "japan", "netherlands", "newzealand",
    "switzerland", "uk",
  ],
  options: { lang: "en" },
